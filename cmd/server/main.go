...
func main() {
    ...
    logConfig := runtimeLogToLogConfig(conf.Runtime.Log)
...
// runtimeLogToLogConfig преобразует RuntimeLogConfig в LogConfig
func runtimeLogToLogConfig(r types.RuntimeLogConfig) types.LogConfig {
